...
page8_messaging::page8_messaging(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::page8_messaging)
{
    ui->setupUi(this);
}

page8_messaging::~page8_messaging()
{
    delete ui;
}

void page8_messaging::on_pushButton_clicked()
{
    page5 *w1 = new page5;
    w1->show();
    this->hide();
...
void page8_messaging::on_pushButton_2_clicked()
{
...
void page8_messaging::on_pushButton_3_clicked()
{
...
void page8_messaging::on_pushButton_4_clicked()
{
...
void page8_messaging::on_pushButton_6_clicked()
{
...
void page8_messaging::on_pushButton_5_clicked()
{
...
void page8_messaging::on_pushButton_7_clicked()
{
    Page1 *w7 = new Page1;
    w7->show();
    this->hide();
